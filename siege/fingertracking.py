...
coin = cv.imread("siege/Coin.jpg", cv.IMREAD_COLOR)
...
while True:
    ...
    coinH, coinW = coin.shape[:2]
    CoinRangeX = random.randint(0,window_w//CoinSpawingSquareSize - 1) 
    CoinRangeY = random.randint(0,window_h//CoinSpawingSquareSize - 1)
    #print(CoinRangeX,CoinRangeY)
                #
    flipped_img[CoinRangeY:CoinRangeY + coinH, CoinRangeX:CoinRangeX + coinW] = coin
